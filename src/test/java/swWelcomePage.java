...
public class swWelcomePage {
     ...
     * */
    @Test
    public void swWelcomePage() {

        String myUrl = "https://www.starwars.com/";
        String elementID = "nav-sw-logo";
        ...
        driver.get(myUrl);
        WebElement element = waitForElementToAppear(By.id(elementID));
